...
- Microsoft 직원이 학습 편의를 위해 개인적으로 만든 자료입니다.
- Microsoft의 **공식 한국어 현지화가 아니며**, Microsoft를 대표하지 않습니다.
- Microsoft의 검토나 승인을 거치지 않았습니다.
- 정확성이 중요한 상황에서는 반드시 원문을 기준으로 판단해 주세요.
...
Microsoft, Microsoft 365, Copilot, Copilot Studio, Power Platform, Dataverse, Azure는 Microsoft Corporation의 상표입니다.

## 이용 범위

학습과 교육 목적의 참조 자료로 제공됩니다. 상업적 재배포나 원문 저작권을 침해하는 방식의 이용은 허용되지 않습니다.

번역문(한국어 문장)과 덧붙인 설명에 한해서는 출처를 밝히면 학습 목적으로 자유롭게 인용하실 수 있습니다.
